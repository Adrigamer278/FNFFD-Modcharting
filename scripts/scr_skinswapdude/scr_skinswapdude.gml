function scr_skinswapdude(argument0) {
	...
	shader_set_uniform_f(shader_get_uniform(shader_colorswap,"sTime"),instance_exists(obj_song) ? obj_song.songpos : current_time/1000)

	with(obj_stats) {
		
		shader_set_uniform_f(shader_get_uniform(shader_colorswap,"alphaMult"),1)
		shader_set_uniform_f(shader_get_uniform(shader_colorswap,"rainbowAmmo"),real(skinrainbow))
